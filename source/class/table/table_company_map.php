...
class table_company_map extends discuz_table
{
    public function __construct()
    {

        $this->_table = 'company_map';
        $this->_pk = 'id';
    ...
    {
        DB::query("INSERT INTO %t ( c_code,p_code, create_time, create_operator) VALUES (%s,%s,%s,%s)",
            array($this->_table, $info['c_code'], $info['p_code'], $info['create_time'], $info['create_operator']));
    }
