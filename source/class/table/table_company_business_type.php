...
class table_company_business_type extends discuz_table
{
    public function __construct()
    {

        $this->_table = 'company_business_type';
        $this->_pk = 'b_id';
    ...
    public function fetch_page_data($where, $start, $limit, $field = '*', $order = 'b_id DESC', $add_where)
    {
    ...
    {
        DB::query("INSERT INTO %t (type_name, parent_id, position, create_time, create_operator) VALUES (%s,%d,%d,%s,%s)",
            array($this->_table, $info['type_name'], $info['parent_id'], $info['position'], $info['create_time'], $info['create_operator']));
    }
