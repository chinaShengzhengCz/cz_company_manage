...
var cateData =
{
    ...
    1: [
        {"id": "1", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "20", "name": "国股行"},
        {"id": "21", "name": "城商行"},
        {"id": "22", "name": "农商行"},
        {"id": "25", "name": "信用社"},
    ...
    18: [
        {"id": "18", "name": "全部", "noChild": 1, "is_all": 1},
    ...
    10: [
        {"id": "10", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "11", "name": "四大AMC"},
        {"id": "12", "name": "地方AMC"},
    ],
    89: [
        {"id": "89", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "90", "name": "金融租赁"},
        {"id": "93", "name": "融资租赁"},
    ],
	90: [
        {"id": "90", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "91", "name": "金租公司", "noChild": 1, "is_all": 1},
        {"id": "92", "name": "其他分支", "noChild": 1, "is_all": 1},
    ],
	93: [
        {"id": "93", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "94", "name": "融资租赁公司", "noChild": 1, "is_all": 1},
        {"id": "95", "name": "其他分支", "noChild": 1, "is_all": 1},
    ],
    86: [
        {"id": "86", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "87", "name": "财务公司", "noChild": 1, "is_all": 1},
        {"id": "88", "name": "其他分支", "noChild": 1, "is_all": 1},
    ],
    11: [
        {"id": "11", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "13", "name": "四大AMC总公司", "noChild": 1, "is_all": 1},
        {"id": "14", "name": "四大AMC分支", "noChild": 1, "is_all": 1},
    ],
	12: [
        {"id": "12", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "15", "name": "地方AMC总公司", "noChild": 1, "is_all": 1},
        {"id": "16", "name": "地方AMC分支", "noChild": 1, "is_all": 1},
    ],
	20: [
        {"id": "20", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "33", "name": "国股行总行", "noChild": 1, "is_all": 1},
        {"id": "34", "name": "一级分行", "noChild": 1, "is_all": 1},
        {"id": "35", "name": "二级分行", "noChild": 1, "is_all": 1},
        {"id": "36", "name": "营业部", "noChild": 1, "is_all": 1},
        {"id": "37", "name": "分支网点", "noChild": 1, "is_all": 1},
        {"id": "38", "name": "专营机构", "noChild": 1, "is_all": 1},
        {"id": "39", "name": "其他", "noChild": 1, "is_all": 1},
    ],
	21: [
        {"id": "21", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "40", "name": "城商行总行", "noChild": 1, "is_all": 1},
        {"id": "41", "name": "一级分行", "noChild": 1, "is_all": 1},
        {"id": "42", "name": "二级分行", "noChild": 1, "is_all": 1},
        {"id": "43", "name": "营业部", "noChild": 1, "is_all": 1},
        {"id": "44", "name": "分支网点", "noChild": 1, "is_all": 1},
        {"id": "45", "name": "专营机构", "noChild": 1, "is_all": 1},
        {"id": "46", "name": "其他", "noChild": 1, "is_all": 1},
    ],
	22: [
        {"id": "22", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "47", "name": "农商行总行", "noChild": 1, "is_all": 1},
        {"id": "48", "name": "一级分行", "noChild": 1, "is_all": 1},
        {"id": "49", "name": "二级分行", "noChild": 1, "is_all": 1},
        {"id": "50", "name": "营业部", "noChild": 1, "is_all": 1},
        {"id": "51", "name": "分支网点", "noChild": 1, "is_all": 1},
        {"id": "52", "name": "专营机构", "noChild": 1, "is_all": 1},
        {"id": "53", "name": "其他", "noChild": 1, "is_all": 1},
    ],
	25: [
        {"id": "25", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "58", "name": "省级联社", "noChild": 1, "is_all": 1},
        {"id": "59", "name": "地级联社", "noChild": 1, "is_all": 1},
        {"id": "60", "name": "县级联社", "noChild": 1, "is_all": 1},
        {"id": "61", "name": "信用社及分社", "noChild": 1, "is_all": 1},
        {"id": "62", "name": "储蓄所", "noChild": 1, "is_all": 1},
        {"id": "63", "name": "其他分支", "noChild": 1, "is_all": 1},
    ],
	24: [
        {"id": "24", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "56", "name": "民营银行总行", "noChild": 1, "is_all": 1},
        {"id": "57", "name": "分支机构", "noChild": 1, "is_all": 1},
    ],
	77: [
        {"id": "77", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "78", "name": "外资行总行", "noChild": 1, "is_all": 1},
        {"id": "79", "name": "分行", "noChild": 1, "is_all": 1},
        {"id": "80", "name": "分支机构", "noChild": 1, "is_all": 1},
    ],
	23: [
        {"id": "23", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "54", "name": "村镇银行总行", "noChild": 1, "is_all": 1},
        {"id": "55", "name": "分支机构", "noChild": 1, "is_all": 1},
    ],
	26: [
        {"id": "26", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "64", "name": "农合行总行", "noChild": 1, "is_all": 1},
        {"id": "65", "name": "支行", "noChild": 1, "is_all": 1},
        {"id": "66", "name": "其他分支", "noChild": 1, "is_all": 1},
		{"id": "27", "name": "资金互助社", "noChild": 1, "is_all": 1},
    ],
	19: [
        {"id": "19", "name": "全部", "noChild": 1, "is_all": 1},
        {"id": "28", "name": "政策行总行", "noChild": 1, "is_all": 1},
        {"id": "29", "name": "一级分行", "noChild": 1, "is_all": 1},
        {"id": "30", "name": "二级分行", "noChild": 1, "is_all": 1},
        {"id": "31", "name": "营业部", "noChild": 1, "is_all": 1},
        {"id": "32", "name": "支行", "noChild": 1, "is_all": 1},
    ]
