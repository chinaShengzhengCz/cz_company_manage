<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('f_zhiya_list');
0
|| checktplrefresh('./source/plugin/company_manage/template/f_zhiya_list.htm', './template/default/company_manage/zhiya_side_left.htm', 1514097767, 'company_manage', './data/template/1_company_manage_f_zhiya_list.tpl.php', './source/plugin/company_manage/template', 'f_zhiya_list')
|| checktplrefresh('./source/plugin/company_manage/template/f_zhiya_list.htm', './template/default/common/footer.htm', 1514097767, 'company_manage', './data/template/1_company_manage_f_zhiya_list.tpl.php', './source/plugin/company_manage/template', 'f_zhiya_list')
...
<div id="pt" class="bm cl">
    <div class="z">
        ...
        <a href="plugin.php?id=company_manage:company_zhiya_list_front">质押库</a>
    </div>
</div>
...
<div id="ct" class="ct2_a wp cl">
    <div class="mn">
        <form class="hidden" id="search_form">
            <input type="hidden" name="finish_alert" value="">
            <input type="hidden" name="dis_recent" value="">
            <input type="hidden" name="zhiya_recent" value="">
            <p>
                <label class="inline">证券代码 <input class="form-control" name="stock_code"/></label>
                <label class="inline">公司名称 <input class="form-control" name="company_name"/></label>
            </p>
            <p>
                <label class="inline">股东名称 <input class="form-control" name="holder_name"/></label>
                <label class="inline"><span  style="width:60px;display:inline-block">质押方</span><input class="form-control" name="zhiya_name"/></label>
            </p>
            <p>
                <label class="inline">质押日期</label>
                <input onclick="showcalendar(event, this, false)" type="text" name="start_date_s" class="px" autocomplete="off" tabindex="1" fwin="mods">
                <input onclick="showcalendar(event, this, false)" type="text" name="start_date_e" class="px" autocomplete="off" tabindex="1" fwin="mods">
            </p>
            <p>
                <label class="inline">到期日期</label>
                <input onclick="showcalendar(event, this, false)" type="text" name="end_date_s" class="px" autocomplete="off" tabindex="1" fwin="mods">
                <input onclick="showcalendar(event, this, false)" type="text" name="end_date_e" class="px" autocomplete="off" tabindex="1" fwin="mods">
            </p>
            <p>
                <label class="inline">解押日期</label>
                <input onclick="showcalendar(event, this, false)" type="text" name="dis_date_s" class="px" autocomplete="off" tabindex="1" fwin="mods">
                <input onclick="showcalendar(event, this, false)" type="text" name="dis_date_e" class="px" autocomplete="off" tabindex="1" fwin="mods">
            </p>
            <input class="btn btn-primary search_button" type="button" value="查询">
        </form>
...
<!--div-->
<ul class="top-menu">
<li><a href="plugin.php?id=company_manage:company_zhiya_list_front">质押数据</a><span></span></li>
<li><a href="javescript:void(0)" onclick="finish_alert();return false;">质押到期提醒</a><span></span></li>
<li><a href="javescript:void(0)" onclick="dis_recent();return false;">近期解押</a><span></span></li>
<li><a href="javescript:void(0)" onclick="zhiya_recent(1);return false;">1个月短期质押</a><span></span></li>
<li><a href="javescript:void(0)" onclick="zhiya_recent(3);return false;">3个月短期质押</a><span></span></li>
<li><a href="javescript:void(0)" onclick="dis_recent(1);return false;">1个月内解押</a><span></span></li>
<li><a href="javescript:void(0)" onclick="dis_recent(3);return false;">3个月内解押</a><span></span></li>
<li><a href="javescript:void(0)" onclick="multi_search();return false;">组合查询</a><span></span>
</li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=2" target="_blank">本站质押项目</a><span></span>    
</li>
</ul>
...
<script src="./source/plugin/company_manage/template/js/f_zhiya_list.js" type="text/javascript"></script>	</div>
