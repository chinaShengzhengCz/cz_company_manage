<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('f_r_list');
0
|| checktplrefresh('./source/plugin/company_manage/template/f_r_list.htm', './template/default/company_manage/ziyuan_side_left.htm', 1514082705, 'company_manage', './data/template/1_company_manage_f_r_list.tpl.php', './source/plugin/company_manage/template', 'f_r_list')
|| checktplrefresh('./source/plugin/company_manage/template/f_r_list.htm', './template/default/common/footer.htm', 1514082705, 'company_manage', './data/template/1_company_manage_f_r_list.tpl.php', './source/plugin/company_manage/template', 'f_r_list')
...
<div id="pt" class="bm cl">
    ...
    <div style="display:inline-block;float:right">
        <a target="_blank" href="plugin.php?id=company_manage:company_human_form" style="float:right">我的资源</a>
    </div>
</div>
...
<div id="ct" class="ct2_a wp cl">
    <div class="mn">
        ...
        <table class="table-responsive" id="human_list"></table>
...
<!--div-->
<ul class="top-menu">
<li><a href="javascript:void(0)" onclick="type_search(2)">股票股权</a><span></span>
<div class="content">
<div class="div-left">
<dl>
<dt>股票</dt>
<dd>
<a href="javascript:void(0)" onclick="type_search(2)">全部</a> <a href="javascript:void(0)" onclick="type_search(3)">质押</a> <a href="javascript:void(0)" onclick="type_search(4)">定增</a> <a href="javascript:void(0)" onclick="type_search(5)">减持</a>
</dd>
</dl>
</div>
</div>
...
<script src="./source/plugin/company_manage/template/js/f_r_list.js" type="text/javascript"></script>	</div>
