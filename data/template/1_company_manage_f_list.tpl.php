...
0
|| checktplrefresh('./source/plugin/company_manage/template/f_list.htm', './template/default/company_manage/side_left.htm', 1514697381, 'company_manage', './data/template/1_company_manage_f_list.tpl.php', './source/plugin/company_manage/template', 'f_list')
|| checktplrefresh('./source/plugin/company_manage/template/f_list.htm', './template/default/common/footer.htm', 1514697381, 'company_manage', './data/template/1_company_manage_f_list.tpl.php', './source/plugin/company_manage/template', 'f_list')
