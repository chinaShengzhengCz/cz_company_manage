...
<?php } ?>
<div class="bm bmw fl">
<div class="subforumshow bm_h cl" href="#company_list">
<span class="o"><img src="<?php echo STATICURL;?>image/mobile/images/collapsed_<?php if(!$_G['setting']['mobile']['mobileforumview']) { ?>yes<?php } else { ?>no<?php } ?>.png"></span>
<h2><a href="javascript:;">企业管理</a></h2>
</div>
<div id="company_list" class="sub_forum bm_c">
<ul>
<li><a href="plugin.php?id=company_manage:company_manage_list_front">企业列表</a></li>
</ul>
</div>
</div>
</div>
