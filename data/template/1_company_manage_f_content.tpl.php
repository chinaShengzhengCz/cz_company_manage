<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('f_content');
0
|| checktplrefresh('./source/plugin/company_manage/template/f_content.htm', './template/default/company_manage/side_left.htm', 1514090166, 'company_manage', './data/template/1_company_manage_f_content.tpl.php', './source/plugin/company_manage/template', 'f_content')
|| checktplrefresh('./source/plugin/company_manage/template/f_content.htm', './template/default/common/footer.htm', 1514090166, 'company_manage', './data/template/1_company_manage_f_content.tpl.php', './source/plugin/company_manage/template', 'f_content')
;?><?php include template('common/header'); if(($oper=='child')||($oper=='holder')||$oper=='contact'||$oper=='thread') { ?>
...
<div id="ct" class="ct2_a wp cl">
    <div class="mn">
        ...
        <ul class="tb cl">
            <li <?php if(($oper=='view')) { ?>class="a"<?php } ?>><a href="plugin.php?id=company_manage:company_manage_content&amp;oper=view&amp;code=<?php echo $company_data['code'];?>">基本资料</a></li>
            <li <?php if(($oper=='child')) { ?>class="a"<?php } ?>><a href="plugin.php?id=company_manage:company_manage_content&amp;oper=child&amp;code=<?php echo $company_data['code'];?>">相关机构</a></li>
            <li <?php if(($oper=='thread')) { ?>class="a"<?php } ?>><a href="plugin.php?id=company_manage:company_manage_content&amp;oper=thread&amp;code=<?php echo $company_data['code'];?>">相关业务信息</a></li>
            <li <?php if(($oper=='contact')) { ?>class="a"<?php } ?>><a href="plugin.php?id=company_manage:company_manage_content&amp;oper=contact&amp;code=<?php echo $company_data['code'];?>">联系方式</a></li>
            <li <?php if(($oper=='holder')) { ?>class="a"<?php } ?>><a href="plugin.php?id=company_manage:company_manage_content&amp;oper=holder&amp;code=<?php echo $company_data['code'];?>">十大股东</a></li>
        </ul>
        <?php if(($oper=='view')) { ?>
        <table cellspacing="0" cellpadding="0" class="tfm" id="profilelist">
            <tr>
                <th>机构简称</th>
                <td><?php if(!empty($company_data)) { ?><?php echo $company_data['shorter_name'];?><?php } ?></td>
            </tr>
            <tr>
                <th>机构全称</th>
                <td><?php if(!empty($company_data)) { ?><?php echo $company_data['full_name'];?><?php } ?></td>
            </tr>
            <tr>
                <th>所属公司</th>
                <td><?php if(!empty($p_list_str)) { ?><?php echo $p_list_str;?><?php } ?></td>
            </tr>
            <tr>
                <th>所属分类</th>
                <td><?php if(!empty($company_data)) { ?><?php echo $company_data['cate_name'];?><?php } ?></td>
            </tr>
            <tr>
                <th>地区</th>
                <td><?php if(!empty($company_data)) { ?><?php echo $company_data['area_name'];?><?php } ?></td>
            </tr>
            <tr>
                <th>负责人</th>
                <td><?php if(!empty($company_data)) { ?><?php echo $company_data['boss'];?><?php } ?></td>
            </tr>
            <tr>
                <th>电话</th>
                <td><?php if(!empty($company_data)) { ?><?php echo $company_data['tel'];?><?php } ?></td>
            </tr>
            <tr>
                <th>详细地址</th>
                <td><?php if(!empty($company_data)) { ?><?php echo $company_data['address'];?><?php } ?></td>
            </tr>
            <tr>
                <th>更新时间</th>
                <td><?php if(!empty($company_data)) { ?><?php echo $company_data['update_time'];?><?php } ?></td>
            </tr>
        </table>
        <?php } elseif(($oper=='child')) { ?>
        <table id="company_list"></table>
        <?php } elseif(($oper=='holder')) { ?>
        <table id="holder_list"></table>
        <?php } elseif(($oper=='contact')) { ?>
        <table id="contact_list"></table>
        <?php } elseif(($oper=='thread')) { ?>
        <table id="thread_list"></table>
        <?php } ?>
...
<dt>期货</dt>
<dd>
<a href="javascript:void(0)" onclick="cate_search(3)">全部</a> <a href="javascript:void(0)" onclick="cate_search(6)">总公司</a> <a href="javascript:void(0)" onclick="cate_search(4)">分公司</a> <a href="javascript:void(0)" onclick="cate_search(5)">营业部</a>
</dd>
</dl>
</div>
</div>
...
<?php if(($oper=='view')) { ?>
<script src="./source/plugin/company_manage/template/js/f_content.js" type="text/javascript"></script>
<?php } elseif(($oper=='child')) { ?>
<script src="./source/plugin/company_manage/template/js/f_content_child.js" type="text/javascript"></script>
<?php } elseif(($oper=='holder')) { ?>
<script src="./source/plugin/company_manage/template/js/f_related_holder.js" type="text/javascript"></script>
<?php } elseif(($oper=='contact')) { ?>
<script src="./source/plugin/company_manage/template/js/f_related_contact.js" type="text/javascript"></script>
<?php } elseif(($oper=='thread')) { ?>
<script src="./source/plugin/company_manage/template/js/f_related_thread.js" type="text/javascript"></script>
<?php } else { ?>
