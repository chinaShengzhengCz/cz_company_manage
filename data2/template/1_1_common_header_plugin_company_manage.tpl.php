...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1512792732, '1', './data/template/1_1_common_header_plugin_company_manage.tpl.php', './template/default', 'common/header_plugin_company_manage')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1512792732, '1', './data/template/1_1_common_header_plugin_company_manage.tpl.php', './template/default', 'common/header_plugin_company_manage')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1512792732, '1', './data/template/1_1_common_header_plugin_company_manage.tpl.php', './template/default', 'common/header_plugin_company_manage')
;?>
