...
0
|| checktplrefresh('./source/plugin/company_manage/template/f_zhiya_detail.htm', './template/default/company_manage/zhiya_side_left.htm', 1512798804, 'company_manage', './data/template/1_company_manage_f_zhiya_detail.tpl.php', './source/plugin/company_manage/template', 'f_zhiya_detail')
|| checktplrefresh('./source/plugin/company_manage/template/f_zhiya_detail.htm', './template/default/common/footer.htm', 1512798804, 'company_manage', './data/template/1_company_manage_f_zhiya_detail.tpl.php', './source/plugin/company_manage/template', 'f_zhiya_detail')
...
<div id="ct" class="ct2_a wp cl">
    <div class="mn">
        ...
        <ul class="tb cl">
            <li <?php if(($oper=='view')) { ?>class="a"<?php } ?>><a href="plugin.php?id=company_manage:company_zhiya_detail&amp;oper=view&amp;zhiya_id=<?php echo $zhiya_data['id'];?>">基本资料</a></li>
            <li <?php if(($oper=='child')) { ?>class="a"<?php } ?>><a href="plugin.php?id=company_manage:company_zhiya_detail&amp;oper=child&amp;zhiya_id=<?php echo $zhiya_data['id'];?>">相关质押</a></li>
        </ul>
        <?php if(($oper=='view')) { ?>
