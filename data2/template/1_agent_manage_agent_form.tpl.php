<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('agent_form');
0
|| checktplrefresh('./source/plugin/agent_manage/template/agent_form.htm', './template/default/common/footer.htm', 1512788754, 'agent_manage', './data/template/1_agent_manage_agent_form.tpl.php', './source/plugin/agent_manage/template', 'agent_form')
;?><?php include template('common/header'); ?><head>
    <link rel="stylesheet" href="./source/plugin/agent_manage/template/css/initial_style.css" type="text/css" media="all">
    <link rel="stylesheet" href="./source/plugin/agent_manage/template/dict/bootstrap/css/bootstrap.min.css" type="text/css" media="all">
    <link rel="stylesheet" href="./source/plugin/agent_manage/template/dict/select2/select2.min.css" type="text/css" media="all">
    <link rel="stylesheet" href="./source/plugin/agent_manage/template/css/agent_manage_common.css" type="text/css" media="all">
    <style>
...
<div id="pt" class="bm cl">
    <div class="z">
        ...
        <a href="plugin.php?id=agent_manage:agent_manage_home_front">合伙人</a>
    </div>
</div>
<div id="ct" class="ct2_a wp cl">
    <form id="add_form" method="post" autocomplete="off" action="plugin.php?id=agent_manage:add_agent_page">
        <div>
        ...
        <div>
            <label>微信名</label><input class="form-control" type="text" name="wechat" value="<?php if(!empty($agent_data)) { ?><?php echo $agent_data['wechat'];?><?php } else { } ?>"/>
        </div>
        <div>
            <label>公司名</label><input class="form-control" type="text" name="company_name" value="<?php if(!empty($agent_data)) { ?><?php echo $agent_data['company_name'];?><?php } else { } ?>"/>
        </div>
...
<script src="./source/plugin/agent_manage/template/dict/jquery/jquery.min.js" type="text/javascript"></script>
<script src="static/js/common.js" type="text/javascript"></script>
<script src="./source/plugin/agent_manage/template/js/form.js" type="text/javascript"></script>	</div>
