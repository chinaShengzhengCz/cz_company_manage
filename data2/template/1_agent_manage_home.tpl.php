<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('home');
0
|| checktplrefresh('./source/plugin/agent_manage/template/home.htm', './template/default/common/footer.htm', 1512788708, 'agent_manage', './data/template/1_agent_manage_home.tpl.php', './source/plugin/agent_manage/template', 'home')
;?><?php include template('common/header'); ?><link rel="stylesheet" href="./source/plugin/company_manage/template/css/initial_style.css" type="text/css" media="all">
...
<div id="ct" class="ct2_a wp cl">
    <h2>合伙人简介</h2>
    <p>这里是合伙人简介</p>
    <button class="btn"><a href="plugin.php?id=agent_manage:agent_manage_form">成为合伙人</a></button>
</div>
<script src="./source/plugin/agent_manage/template/dict/jquery/jquery.min.js" type="text/javascript"></script>
<script src="./source/plugin/agent_manage/template/js/home.js" type="text/javascript"></script>	</div>
