...
0
|| checktplrefresh('./source/plugin/company_manage/template/f_zhiya_list.htm', './template/default/company_manage/zhiya_side_left.htm', 1512806097, 'company_manage', './data/template/1_company_manage_f_zhiya_list.tpl.php', './source/plugin/company_manage/template', 'f_zhiya_list')
|| checktplrefresh('./source/plugin/company_manage/template/f_zhiya_list.htm', './template/default/common/footer.htm', 1512806097, 'company_manage', './data/template/1_company_manage_f_zhiya_list.tpl.php', './source/plugin/company_manage/template', 'f_zhiya_list')
...
<div id="ct" class="ct2_a wp cl">
    <div class="mn">
        <form class="hidden" id="search_form">
            <input type="hidden" name="finish_alert" value="0">
            <input type="hidden" name="dis_recent" value="0">
            <p>
...
<li><a href="javescript:void(0)" onclick="jQuery('#search_form').toggle()">组合查询</a><span></span>
</li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=2" target="_blank">质押项目</a><span></span>    
</li>
</ul>
