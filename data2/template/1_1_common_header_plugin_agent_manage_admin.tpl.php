...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1512781990, '1', './data/template/1_1_common_header_plugin_agent_manage_admin.tpl.php', './template/default', 'common/header_plugin_agent_manage_admin')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1512781990, '1', './data/template/1_1_common_header_plugin_agent_manage_admin.tpl.php', './template/default', 'common/header_plugin_agent_manage_admin')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1512781990, '1', './data/template/1_1_common_header_plugin_agent_manage_admin.tpl.php', './template/default', 'common/header_plugin_agent_manage_admin')
;?>
